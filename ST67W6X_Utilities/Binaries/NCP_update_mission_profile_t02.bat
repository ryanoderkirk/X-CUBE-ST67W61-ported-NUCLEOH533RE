...
%current_dir%QConn_Flash\QConn_Flash_Cmd.exe --port %COMADDR% --config %current_dir%NCP_Binaries\mission_t02_flash_prog_cfg.ini --efuse=%current_dir%\NCP_Binaries\efusedata.bin
if %ERRORLEVEL% neq 0 goto :error
