 ...
 */
#ifdef CONFIG_PERCEPIO_TRC_CFG_STREAM_PORT_TRACE_FILE
 ...
 */
#ifdef CONFIG_PERCEPIO_TRC_CFG_STREAM_PORT_INTERNAL_BUFFER_SIZE
...
#else
#define TRC_CFG_STREAM_PORT_INTERNAL_BUFFER_CHUNK_SIZE 4096UL
#endif
