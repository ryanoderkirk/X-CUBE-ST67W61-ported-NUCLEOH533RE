...
#if (USE_IKS01A3_MOTION_SENSOR_LSM6DSV80X_0 == 1)
...
/**
  ...
  * @retval BSP status
  */
int32_t IKS01A3_MOTION_SENSOR_GetSensitivity(uint32_t Instance, uint32_t Function, float_t *Sensitivity)
{
  int32_t ret;
...
/**
  ...
  * @retval BSP status
  */
int32_t IKS01A3_MOTION_SENSOR_GetOutputDataRate(uint32_t Instance, uint32_t Function, float_t *Odr)
{
  int32_t ret;
...
/**
  ...
  * @retval BSP status
  */
int32_t IKS01A3_MOTION_SENSOR_SetOutputDataRate(uint32_t Instance, uint32_t Function, float_t Odr)
{
  int32_t ret;
...
static int32_t LSM6DSV16X_0_Probe(uint32_t Functions)
{
  ...
  io_ctx.Address     = LSM6DSV16X_I2C_ADD_L;
  io_ctx.Init        = IKS01A3_I2C_INIT;
  io_ctx.DeInit      = IKS01A3_I2C_DEINIT;
  io_ctx.ReadReg     = IKS01A3_I2C_READ_REG;
  io_ctx.WriteReg    = IKS01A3_I2C_WRITE_REG;
  ...
  else
  {
    ...
    MotionCtx[IKS01A3_LSM6DSV16X_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS01A3_LSM6DSV16X_0] = &lsm6dsv16x_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS01A3_LSM6DSV16X_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSV16X_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV16X_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV16X_GYRO_Driver;

      if (MotionDrv[IKS01A3_LSM6DSV16X_0]->Init(MotionCompObj[IKS01A3_LSM6DSV16X_0]) != LSM6DSV16X_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV16X_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV16X_ACC_Driver;
...
static int32_t LSM6DSV16BX_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS01A3_LSM6DSV16BX_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS01A3_LSM6DSV16BX_0] = &lsm6dsv16bx_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS01A3_LSM6DSV16BX_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSV16BX_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV16BX_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV16BX_GYRO_Driver;
...
static int32_t LSM6DSV32X_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS01A3_LSM6DSV32X_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS01A3_LSM6DSV32X_0] = &lsm6dsv32x_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS01A3_LSM6DSV32X_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSV32X_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV32X_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV32X_GYRO_Driver;

      if (MotionDrv[IKS01A3_LSM6DSV32X_0]->Init(MotionCompObj[IKS01A3_LSM6DSV32X_0]) != LSM6DSV32X_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV32X_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV32X_ACC_Driver;
...
static int32_t ISM330BX_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS01A3_ISM330BX_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS01A3_ISM330BX_0] = &ism330bx_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS01A3_ISM330BX_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&ISM330BX_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_ISM330BX_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&ISM330BX_GYRO_Driver;

      if (MotionDrv[IKS01A3_ISM330BX_0]->Init(MotionCompObj[IKS01A3_ISM330BX_0]) != ISM330BX_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_ISM330BX_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&ISM330BX_ACC_Driver;
...
static int32_t LSM6DSV80X_0_Probe(uint32_t Functions)
{
  ...
  else
  {
    ...
    MotionCtx[IKS01A3_LSM6DSV80X_0].Functions = ((uint32_t)cap.Gyro) | ((uint32_t)cap.Acc << 1) | ((uint32_t)cap.Magneto << 2);

    MotionCompObj[IKS01A3_LSM6DSV80X_0] = &lsm6dsv80x_obj_0;
    /* The second cast (void *) is added to bypass Misra R11.3 rule */
    MotionDrv[IKS01A3_LSM6DSV80X_0] = (MOTION_SENSOR_CommonDrv_t *)(void *)&LSM6DSV80X_COMMON_Driver;

    if ((ret == BSP_ERROR_NONE) && ((Functions & MOTION_GYRO) == MOTION_GYRO) && (cap.Gyro == 1U))
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV80X_0][FunctionIndex[MOTION_GYRO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV80X_GYRO_Driver;

      if (MotionDrv[IKS01A3_LSM6DSV80X_0]->Init(MotionCompObj[IKS01A3_LSM6DSV80X_0]) != LSM6DSV80X_OK)
      {
        ret = BSP_ERROR_COMPONENT_FAILURE;
      }
      else
    ...
    {
      /* The second cast (void *) is added to bypass Misra R11.3 rule */
      MotionFuncDrv[IKS01A3_LSM6DSV80X_0][FunctionIndex[MOTION_ACCELERO]] = (MOTION_SENSOR_FuncDrv_t *)(void *)&LSM6DSV80X_ACC_Driver;
