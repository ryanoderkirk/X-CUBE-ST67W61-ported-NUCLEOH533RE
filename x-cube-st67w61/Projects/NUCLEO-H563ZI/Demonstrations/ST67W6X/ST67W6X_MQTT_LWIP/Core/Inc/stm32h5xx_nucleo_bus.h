...
#ifndef STM32H5XX_NUCLEO_BUS_H
#define STM32H5XX_NUCLEO_BUS_H
...
/** @defgroup STM32H5XX_NUCLEO_BUS_Exported_Constants STM32H5XX_NUCLEO BUS Exported Constants
  * @{
  */
...
/** @defgroup STM32H5XX_NUCLEO_BUS_Private_Types STM32H5XX_NUCLEO BUS Private types
  * @{
  */
...
/** @defgroup STM32H5XX_NUCLEO_LOW_LEVEL_Exported_Variables LOW LEVEL Exported Constants
  * @{
  */
...
/** @addtogroup STM32H5XX_NUCLEO_BUS_Exported_Functions
  * @{
  */
