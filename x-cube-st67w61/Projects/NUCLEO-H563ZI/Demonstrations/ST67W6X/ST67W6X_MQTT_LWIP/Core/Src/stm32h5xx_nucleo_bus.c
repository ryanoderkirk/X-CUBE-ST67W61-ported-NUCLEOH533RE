...
/* Includes ------------------------------------------------------------------*/
#include "stm32h5xx_nucleo_bus.h"
...
/** @defgroup STM32H5XX_NUCLEO_BUS STM32H5XX_NUCLEO BUS
  * @{
  */

/** @defgroup STM32H5XX_NUCLEO_BUS_Exported_Variables BUS Exported Variables
  * @{
  */
...
/** @defgroup STM32H5XX_NUCLEO_BUS_Private_Variables BUS Private Variables
  * @{
  */
...
/** @defgroup STM32H5XX_NUCLEO_BUS_Private_FunctionPrototypes  BUS Private Function
  * @{
  */
...
/** @defgroup STM32H5XX_NUCLEO_LOW_LEVEL_Private_Functions STM32H5XX_NUCLEO LOW LEVEL Private Functions
  * @{
  */

/** @defgroup STM32H5XX_NUCLEO_BUS_Exported_Functions STM32H5XX_NUCLEO_BUS Exported Functions
  * @{
  */
